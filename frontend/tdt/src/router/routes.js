...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'editproject', component: () => import('pages/projects/editproject.vue') },
      { path: 'editprojectnotes', component: () => import('pages/projects/editprojectnotes.vue') },
      { path: 'editprojectwebsite', component: () => import('pages/projects/editprojectwebsite.vue') },
